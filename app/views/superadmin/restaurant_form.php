...
$availablePlans = SubscriptionManager::getAllPlans(true); // Get only active plans
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <form id="restaurantForm">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" name="tin" value="<?php echo htmlspecialchars($restaurant['tin'] ?? ''); ?>" pattern="[0-9]{9,10}" maxlength="10" placeholder="e.g., 123456789" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="plan-options">
                            <?php 
                            $currentPlan = $restaurant['subscription_plan'] ?? ($availablePlans[0]['plan_name'] ?? 'trial');
                            foreach ($availablePlans as $plan): 
                                $priceDisplay = $plan['price_monthly'] > 0 
                                    ? number_format($plan['price_monthly']) . ' RWF/mo' 
                                    : 'Free / ' . $plan['duration_days'] . ' days';
                            ?>
                            <div class="plan-option">
                                <input type="radio" name="subscription_plan" id="plan_<?php echo $plan['plan_name']; ?>" 
                                       value="<?php echo htmlspecialchars($plan['plan_name']); ?>" 
                                       <?php echo $currentPlan === $plan['plan_name'] ? 'checked' : ''; ?> 
                                       required>
                                <label for="plan_<?php echo $plan['plan_name']; ?>" class="plan-label">
                                    <div class="plan-name"><?php echo htmlspecialchars($plan['display_name']); ?></div>
                                    <div class="plan-price"><?php echo $priceDisplay; ?></div>
                                </label>
                            </div>
                            <?php endforeach; ?>
                        </div>
